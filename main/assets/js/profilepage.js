function generateVideoTags(data, url)
{
	...
	//SHARE
	outputVideo += "<a  onclick=\"share('" + url + "/videos/load/" + data.v_id + "', '" + data.poster_frame + "', '" + source + "', '" + data.name + "', '" + data.description + "')\" class=\"btn btn-facebook\" style=\"color:#3B5999;\"><i class=\"fa fa-facebook\"></i> Share on Facebook</a>";
